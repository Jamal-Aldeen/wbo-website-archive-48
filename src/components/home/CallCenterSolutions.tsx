    ...
    <section className="section-padding bg-wbo-blue text-white">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            <h3 className="text-xl font-semibold mb-4 border-b border-wbo-offwhite/30 pb-2">Services We Offer</h3>
            <ul className="space-y-3">
              {services.map((service, index) => (
                <li key={index} className="flex items-center">
                  <svg className="w-5 h-5 mr-2 text-wbo-lightblue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4 border-b border-wbo-offwhite/30 pb-2">Industries We Serve</h3>
            <ul className="space-y-3">
